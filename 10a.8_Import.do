...
quietly infix                 ///
  ...
  byte    majoract   84-84    ///
  byte    intenfwk   85-85    ///
  double  ftotval    86-95    ///
  double  inctot     96-104   ///
  double  incwage    105-112  ///
  double  adjginc    113-120  ///
  int     eitcred    121-124  ///
  byte    filestat   125-125  ///
  long    taxinc     126-132  ///
  using `"cps_00008.dat"'
...
save "/Users/matthewspitzer/Desktop/EITC/Intermediate/cps00008.dta"
