...
// mhd: comment these 2 lines out to bring data form your directory 
global path_mahdi = "//wsl$/Ubuntu/home/mahdi/Documents/eitc"
use "$path_mahdi/Intermediate/cps00008.dta", clear
...
bysort cpsid (year): gen numobs = _n
...
// mhd_ it can be the case that serial 155 in year 1993 denotes household A
// and serial 155 in year 1994 denotes household B


// Question: how to make the single identifier?
// mhd's suggestion -- maming it by cpsid or cpsidp
// do we want to have only one row for each household? 
